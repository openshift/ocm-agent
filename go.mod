...
replace (
	...
	k8s.io/api v0.29.4 => k8s.io/api v0.28.2
	k8s.io/apimachinery v0.31.1 => k8s.io/apimachinery v0.28.2
	k8s.io/cli-runtime v0.29.4 => k8s.io/cli-runtime v0.28.2
	k8s.io/client-go v0.29.4 => k8s.io/client-go v0.28.2
	k8s.io/kubectl v0.29.4 => k8s.io/kubectl v0.28.2
	sigs.k8s.io/controller-runtime v0.17.2 => sigs.k8s.io/controller-runtime v0.15.0
)
